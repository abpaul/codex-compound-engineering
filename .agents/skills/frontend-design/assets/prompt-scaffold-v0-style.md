# UI Prompt Scaffold (Product / Context / Constraints)

Use this scaffold when preparing a frontend design request or execution prompt.
...
- Visual taste anchors:
  - examples to emulate
  - examples to avoid
- Motion policy (expressive/subtle/reduced)
