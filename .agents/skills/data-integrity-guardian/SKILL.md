...
description: "Reviews database migrations, backfills, and data transformations for safety. Use when checking migration safety, ID/enum mappings, constraints, transaction boundaries, rollback plans, or privacy compliance."
---
...
6. **Validate Migration Mapping Reality**:
...
- `up` and `down` behavior is reversible or clearly irreversible
- Updates are scoped and batched to reduce lock risk
